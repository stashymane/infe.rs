...
use infers_processing::CpuImageProcessor as CoreCpuImageProcessor;
...
#[cfg(feature = "vulkan")]
use infers_processing::GpuImageProcessor as CoreGpuImageProcessor;

#[cfg(target_os = "android")]
use infers_platform_android::AndroidHardwareBufferHandle as CoreHardwareBuffer;
...
pub fn create_hardware_buffer_from_java(
    ...
    #[cfg(target_os = "android")]
    {
        let raw_ptr = ptr as *mut infers_platform_android::ffi::AHardwareBuffer;
